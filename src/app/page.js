      ...
      <div className="bg-white p-8 rounded-lg shadow-lg text-center">
        ...
        <div className="text-left mb-6">
          <ol className="list-decimal list-inside text-sm md:text-base">
            <li>Your username is your email address, and your password is your SURNAME or FIRST NAME in lowercase letters. For example, if your surname is "Obafemi," your password will be "obafemi."</li>
            <li>If you entered the details correctly and you get an error message saying "wrong credentials," try using your LAST NAME as your password (in lowercase letters). For example, "Obafemi Awolowo" should try "awolowo" if "obafemi" does not work.</li>
