export const sections = [
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["Acceptance", "Availability", "Education"],
        answer: "Acceptance",
      },
      {
        question:
          "Ideally, people groups are always defined as a group of people that understand themselves well and are bound by cultural and traditional heritages.",
      ...
      },
      {
        ...
        options: ["Maybe", "True", "False"],
        answer: "True",
      },
      {
        question:
          "'The Spirit of Christ is the Spirit of missions. The nearer we get to Him, the more intensely missionary we become.' The above quote was made by:",
        options: ["Kenneth E. HAGIN", "Henry Martyn", "Matt Beemer"],
        answer: "Henry Martyn",
      },
      {
        question:
          "The following are the Biblical mediums by which the Gospel is made known except:",
        options: [
      ...
      {
        question:
          "Complete these lines with appropriate words according to Romans 10:4: Send, Preach, Hear, Believe ----- and ‐------",
        options: ["See, Know", "Call, See", "Call, Saved"],
        answer: "Call, Saved",
      },
      {
        question:
        ...
        answer: "Impacting lives with the Gospel",
      },
      {
        question:
          "The following manifestation of the Spirit will be frequent in the ministry of an evangelist except:",
        options: [
          "The Power gifts",
          "Gifts of Healings",
          "Profound Knowledge of the Word",
        ],
        answer: "Profound Knowledge of the Word",
      },
      {
        question:
          "Global Evangelization is a major instruction from the Lord Jesus Christ to be carried out by:",
        options: ["Apostles", "Believers", "Evangelists"],
        answer: "Believers",
      },
    ],
  },
  {
    ...
    questions: [
      {
        question:
          "The science and art of preaching, teaching, and communicating is known as:",
        options: ["Hermeneutics", "Homiletics", "Hermology"],
        answer: "Homiletics",
      },
      {
        question:
          "In the New Testament, the message or proclamation of the heralds of God or Christ is known as:",
        options: ["Teaching", "Preaching", "Exhorting"],
        answer: "Preaching",
      },
      {
        question: "The following are wrong motives for preaching except:",
        options: ["For an Occupation", "For Edification", "For Monetary gains"],
        answer: "For Edification",
      },
      {
        question:
          "The preaching of the Gospel is not with enticing words of man's wisdom but by the power of God.",
        options: ["True", "False", "Not sure"],
        answer: "True",
      },
      {
        question: "The following are types of sermons except:",
        options: ["Based on the Word", "Based on Topics", "Based on Trends"],
        answer: "Based on Trends",
      },
      {
        question: "The following are types of preaching except:",
        options: ["Reproof", "Critiquing", "Rebuke"],
        answer: "Critiquing",
      },
      {
        question: "The following are sermons based on doctrine except:",
        options: ["Soteriology", "Eschatology", "Lot, the backslidden Father"],
        answer: "Lot, the backslidden Father",
      },
      {
        question:
          "The act of worshipping, communing with the Holy Spirit, and spending time in the Word of God alone in one's private life is known as:",
        options: ["Public Worship", "Personal Devotion", "Temple Worship"],
        answer: "Personal Devotion",
      },
      {
        question:
          "A sermon is in three parts, including all the following except:",
        options: ["Excerpts", "The Introduction", "The Invitation"],
        answer: "Excerpts",
      },
      {
        question:
          "The preaching of the Gospel must be devoid of all distractions. A preacher of the Word must pay attention to what he/she wears, speaks, gesticulates, and speaks.",
        options: ["Not Necessarily", "True", "False"],
        answer: "Not Necessarily",
      },
      {
        question:
          "'Let your speech be always with grace, seasoned with salt, that ye may know how ye ought to answer every man.' Where can the above text be found?",
        options: [
          "Colossians 4 vs 2",
          "Colossians 4 vs 6",
          "Colossians 4 vs 8",
        ],
        answer: "Colossians 4 vs 6",
      },
      {
        question:
          "As a minister of the Gospel, the following should characterize your appearance: Simplicity, Neatness, and Spirituality.",
        options: ["False", "True", "Not Important"],
        answer: "True",
      },
    ],
  },
